"""
Inception3 Class copied from https://github.com/pytorch/vision/blob/master/torchvision/models/inception.py

Further modified to plug into our training module
